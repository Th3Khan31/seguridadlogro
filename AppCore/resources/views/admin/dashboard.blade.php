...
@push('css')
    ...
    <!-- fullCalendar -->
    <link rel="stylesheet" href="{{ asset('AppResources/plugins/fullcalendar/main.min.css') }}">
    <link rel="stylesheet" href="{{ asset('AppResources/plugins/fullcalendar-daygrid/main.min.css') }}">
    <link rel="stylesheet" href="{{ asset('AppResources/plugins/fullcalendar-timegrid/main.min.css') }}">
    <link rel="stylesheet" href="{{ asset('AppResources/plugins/fullcalendar-bootstrap/main.min.css') }}">
		...
		<div class="row">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="{{ route('watchmen.index') }}" class="small-box-footer">Más información <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="{{ route('admin.assignment') }}" class="small-box-footer">Más información <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
...
<section class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			<b>Hola,</b> {{ Auth::user()->name }} {{ Auth::user()->last_name }}
		</div>
		<!-- /.card-body -->
...
@push('js')
<script src="{{ asset('AppResources/plugins/fullcalendar/main.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('AppResources/plugins/fullcalendar/locales/es.js') }}"></script>
<script src="{{ asset('AppResources/plugins/fullcalendar-daygrid/main.min.js') }}"></script>
<script src="{{ asset('AppResources/plugins/fullcalendar-timegrid/main.min.js') }}"></script>
<script src="{{ asset('AppResources/plugins/fullcalendar-interaction/main.min.js') }}"></script>
<script src="{{ asset('AppResources/plugins/fullcalendar-bootstrap/main.min.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('AppResources/js/admin/dashboard.js') }}"></script>
<script type="text/javascript" src="{{ asset('AppResources/js/admin/assignment-list.js') }}"></script>
@endpush
