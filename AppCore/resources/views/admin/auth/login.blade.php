...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('AppResources/plugins/fontawesome-free/css/all.min.css') }}">
      ...
      <!-- icheck bootstrap -->
      <link rel="stylesheet" href="{{ asset('AppResources/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
      <!-- Theme style -->
...
<body class="hold-transition login-page">
    ...
    <script type="text/javascript" src="{{ asset('AppResources/js/admin/login.js') }}"></script>
</body>
</html>
